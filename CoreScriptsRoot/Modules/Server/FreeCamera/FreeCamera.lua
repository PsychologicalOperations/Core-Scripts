...
local UpdateFreecam do
	...
	function UpdateFreecam()
		...
		local kx = (IsDirectionDown(DIRECTION_RIGHT) and 1 or 0) - (IsDirectionDown(DIRECTION_LEFT) and 1 or 0) -- seems like a normalization vector, logically cant move in both directions in same time
